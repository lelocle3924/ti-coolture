...
| HP-04 | Bản đồ route khám phá — **hybrid trên mobile** | P1 | *Desktop:* SVG có pan/zoom, pin đánh số, polyline nối stop, click pin → panel chi tiết. *Mobile:* ảnh route **tĩnh** (không pan/zoom) hiện toàn tuyến ở trên, chạm → mở modal fullscreen; bên dưới là danh sách stop theo thứ tự. Xem 5.8 để biết lý do |
